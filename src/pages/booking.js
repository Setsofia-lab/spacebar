          ...
          <div className="container" style={{marginRight:"25px", marginLeft:"25px"}}>
            <div className="row align-items-center">
              <div className="col-lg-6">
                <img src={require("../images/wedding.jpg")} alt="" style={{height:"250px"}} />
                <h4
                  style={{
                    textAlign: "left",
                    fontWeight: "400",
                ...
                <p>
                  ...
                  can offer creative set designs and all lighting and grip
                  demands of the most talented and demanding of creatives. One
                  of New York oldest prop-house is 10 ft away, opening up a
                  whole new real of set up possibilities. And we are have a
                  network of talents: from make up artists and stylist to set
                  designers and print{" "}
                </p>
                <hr></hr>
                <h5>Rate</h5>
                ...
                <p>
                  ...
                  security. Once you confirm, your guests will receive
